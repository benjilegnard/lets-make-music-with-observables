...
interface BpmToIntervalProps { withTick?: boolean };

export const BpmToInterval: FunctionComponent<BpmToIntervalProps> = (props) => {
    const [bpm, setBpm] = useState(80);
    const nexttBpm = (value: number) => { bpmValue$.next(value) }
    ...
    return (
        <div style={{
            ...
            <Slider
                ...
                step={1}
                value={bpm}
                onChange={(value) => { setBpm(value); nexttBpm(value); }}
            />
...
export const BpmToIntervalWithTick: FunctionComponent = () => <BpmToInterval withTick={true} />;
